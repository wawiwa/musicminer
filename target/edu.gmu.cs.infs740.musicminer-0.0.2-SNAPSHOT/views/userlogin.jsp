...
<s:url var="authUrl" value="/secure/authenticate"/>
<form id="form1" name="form1" method="post" action="${authUrl}">
  <p><img src="<%=request.getContextPath()%>/resources/img/gmu1.jpg" width="629" height="355"  alt=""/>
  <h1>User Login Page!</h1>
  <div class="contentcontainer" style="margin-top:100px; width:950px">
    <div>
     <ul class="jq-menu">
      	<li><a href="<s:url value="/secure/search"/>"> <font color="#FF9900">Old Search </font></a></li>
       	<li><a href="<s:url value="/secure/login"/>"> <font color="#FF9900">User Login </font></a></li>
<!-- 		<li><a href="registration.jsp"><font color="#FF9900">Registration</font></a></li> -->
		<li><a href="<s:url value="/secure/search"/>"> <font color="#FF9900">Music Search</font></a></li>
      </ul>
    </div>
